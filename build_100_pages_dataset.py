...
for p_num in range(33, 101):
    if 33 <= p_num <= 40:
        ...
        # Major Crop Packages of Practices (61-70)
        crops_list = ["Rice (Paddy)", "Wheat", "Cotton", "Tomato", "Maize (Corn)", "Potato", "Mustard (Rapeseed)", "Chilli (Capsicum)", "Sugarcane", "Soybean"]
        ...
        # Livestock Farming & Integrated Farming Systems (IFS)
        livestock_topics = [
            ("Dairy Cattle & Buffalo Management", "Gir, Sahiwal, Murrah, Crossbred HF", "PAGE 71: LIVESTOCK FARMING - DAIRY CATTLE & BUFFALO MANAGEMENT\nCore Practices for Profitable Dairy:\n1. Breeds & Genetics: High-yielding indigenous breeds (Gir, Sahiwal, Rathi) and buffaloes (Murrah, Nili-Ravi) yielding 12-18 L/day with high A2 milk and fat content (7-8% in buffaloes).\n2. Balanced Nutrition & TMR: Feed Total Mixed Ration (TMR) comprising 60% green fodder (25-30 kg/day), 20% dry roughage (5-6 kg wheat/paddy straw), and 20% concentrate feed with 20% crude protein + 50 g mineral mixture.\n3. Housing & Milking Hygiene: Free-stall loose housing with grooved non-slip concrete flooring, automated nipple drinkers, and fly/mosquito netting. Wash udder with potassium permanganate solution before milking.\n4. Health & Mastitis Prevention: Practice post-milking teat dipping in 0.5% povidone-iodine. Routine vaccination against Foot & Mouth Disease (FMD), Hemorrhagic Septicemia (HS), and Black Quarter (BQ)."),
            ("Green Fodder Production & Silage Making", "Napier Hybrid CO-4, Berseem, Maize, Lucerne", "PAGE 72: LIVESTOCK FEED - FODDER PRODUCTION & SILAGE PRESERVATION\nYear-Round Green Fodder Security:\n1. High-Yielding Perennial Grasses: Super Napier (CO-4 / CO-5) yielding 150-200 tonnes/acre/year across 6-8 cuts at 45-day intervals.\n2. Winter & Leguminous Fodder: Berseem (Trifolium alexandrinum) and Lucerne (Alfalfa) providing 20-22% crude protein, cutting concentrate feed cost by 35%.\n3. Bunker & Pit Silage Making (Maize Fodder):\n- Harvest single-cross fodder maize at 50% milk-line (30-35% dry matter).\n- Chop to 1.5-2.0 cm, inoculate with Lactobacillus plantarum (1x10^6 CFU/g) or 1% jaggery water.\n- Compact tightly in concrete bunker silos to expel oxygen; seal hermetically with 200-micron UV plastic.\n- Ferments in 45 days into golden-brown aromatic silage (pH 3.8-4.2, lactic acid >6%), stored safely for up to 2 years."),
            ("Goat & Sheep Farming & Stall-Fed Rearing", "Black Bengal, Jamnapari, Sirohi, Osmanabadi, Boer", "PAGE 73: LIVESTOCK FARMING - SMALL RUMINANT MANAGEMENT (GOAT & SHEEP)\nCommercial Goat & Sheep Production:\n1. Prolific Breeds: Black Bengal (high twinning rate >80%), Jamnapari & Sirohi (dual-purpose meat & milk), Boer crosses (rapid daily weight gain 150-200 g/day).\n2. Elevated Slatted Housing: Wooden/plastic slatted floors elevated 1.0 meter above ground. Separates feces and urine, eliminating 90% foot rot and respiratory diseases.\n3. Stall-Feeding (Zero-Grazing): Intensive stall-feeding with chopped fodder (Subabul, Moringa, Lucerne) + concentrate pellet feed (16% CP) achieving Feed Conversion Ratio (FCR) of 1:5.\n4. Deworming & Health Schedule: Strategic deworming using Albendazole / Ivermectin rotating every 3 months; vaccinate against Peste des Petits Ruminants (PPR) and Enterotoxemia (ETV)."),
            ("Poultry Farming (Broiler, Layer & Backyard Kadaknath)", "Kadaknath, Vanaraja, Cobb 500, BV 300", "PAGE 74: LIVESTOCK FARMING - POULTRY PRODUCTION & BIOSECURITY\nPoultry Systems & Management:\n1. Commercial Broiler Farming (Cobb 500 / Ross 308): Deep litter housing (rice husk 2 inches), automated pan feeding, and nipple drinking. Target 2.0 kg live body weight at 35-38 days with FCR < 1.55.\n2. Layer Farming (BV 300 / Hy-Line): Battery cage / enriched cage housing producing 310-325 eggs per bird over 72-week cycle.\n3. Backyard & Free-Range Poultry (Kadaknath, Gramapriya, Vanaraja): High-protein black meat Kadaknath commanding premium market price (Rs 600-800/kg). Requires semi-intensive night shelter and daytime scavenging with supplemental grain feed.\n4. Vaccination Protocol: Day 1 (Marek's Disease), Day 7 (Newcastle/Ranikhet F1 / Lasota), Day 14 (Infectious Bursal Disease IBD/Gumboro)."),
            ("Integrated Farming System (IFS) 1-Hectare Model", "Crops + Dairy (2 Cows) + Fishery + Biogas + Vermicompost", "PAGE 75: INTEGRATED FARMING SYSTEM (IFS) & RESOURCE RECYCLING\n1-Hectare High-Income Integrated Farming System (IFS):\n1. Spatial Allocation: Crops & Horticulture (0.75 ha), Dairy Unit (2 Cows + 2 Buffaloes - 0.05 ha), Farm Pond & Aquaculture (0.10 ha), Agroforestry & Boundary (0.05 ha), Biogas & Vermicompost Unit (0.05 ha).\n2. Nutrient & Energy Waste Cycling:\n- Cattle dung and urine (40 kg/day) feed a 2 m3 Biogas Plant providing clean cooking gas + enriched bio-slurry.\n- Bio-slurry and crop straw feed Eisenia fetida earthworms in Vermicomposting beds, generating 12 tonnes/year organic fertilizer.\n- Farm pond (1000 m2) stocked with Indian Major Carps (Catla, Rohu, Mrigal) fertilized with cattle manure, producing 400-500 kg fish/year.\n3. Economics & Sustainability: Generates steady daily income (milk, eggs, vegetables, fish), reduces external purchased inputs by 75%, and triples net farm profit to Rs 3,50,000 - 5,00,000/ha/year.")
        ]
        topic, crop, text = livestock_topics[p_num - 71]
    elif 76 <= p_num <= 85:
        ...
        # Farming Procedures, Equipment, Sustainability & Safety
        special_topics = [
            ("Farming Safety & Precautions Overview", "All Farming Operations", "PAGE 86: FARM SAFETY & PRECAUTIONS - 10 COMMANDMENTS\nEssential Farming Precautions & Safety Guidelines:\n1. Chemical Spraying Precautions: Always wear Personal Protective Equipment (PPE) including chemical-resistant nitrile gloves, N95/respirator mask, protective goggles, and full-sleeve coveralls. Never spray against wind direction or in high heat (>35°C).\n2. Storage & Labeling: Store all pesticides in original labeled containers inside locked, well-ventilated sheds away from food, animal feed, and children.\n3. Pre-Harvest Interval (PHI): Observe mandatory PHI waiting periods (e.g. 3-7 days for vegetables, 14-21 days for cereals) between the final chemical spray and harvesting to prevent toxic residue exceedances.\n4. Machinery Safety: Ensure all tractor PTO shafts, belt drives, and combine augers are fitted with protective safety shields. Disengage power before unclogging machinery.\n5. Container Disposal: Triple-rinse empty pesticide containers, puncture bottom to prevent reuse, and dispose of through authorized agricultural hazardous waste channels."),
            ("Farming Equipment & Modern Agricultural Machinery", "Tractors, Harvesters, Planters, Drones", "PAGE 87: FARMING EQUIPMENT & AGRICULTURAL MACHINERY\nModern Mechanization Solutions:\n1. Primary Tillage Implements: Mouldboard (MB) Plough for deep inversion; Disc Plough for trashy soils; Chisel Plough (Subsoiler) for breaking hardpan at 45-60 cm depth.\n2. Secondary Tillage: Tractor Rotavator (PTO driven 540 RPM) preparing fine tilth in single pass; Disc Harrow for breaking clods.\n3. Precision Sowing & Planting Machinery: Multi-crop Pneumatic Planter ensuring singulated seed placement; Happy Seeder / Super Seeder for direct sowing into standing stubble; Rice Transplanter (4-8 row walk-behind/ride-on) planting 3-4 acres/day at 30x14 cm.\n4. Crop Protection & Harvest: Boom Sprayers (12-18 meter swath); Drone Sprayers (10 L tank, 1 acre/7 mins); Self-Propelled Combine Harvester with SMS (Straw Management System)."),
            ("Agricultural Sustainability & Carbon Neutral Farming", "Regenerative & Climate-Smart Farming", "PAGE 88: AGRICULTURAL SUSTAINABILITY & REGENERATIVE PRACTICES\nCore Pillars of Sustainable Agriculture:\n1. Soil Carbon Sequestration: Retaining crop residues in-situ increases soil organic carbon (SOC) by 0.15-0.25% annually, improving soil water retention and locking 2-3 tonnes CO2 equivalent per hectare.\n2. Biochar Soil Amendment: Pyrolysis of agricultural biomass (cotton stalks, rice husk) into stable porous biochar applied @ 2-5 tonnes/ha permanently sequesters carbon for 100+ years and enhances CEC by 40%.\n3. Solar Pumping & Clean Energy: Replacing diesel pumps with solar PV systems (PM-KUSUM) reduces farm greenhouse gas emissions by 4.5 tonnes CO2/pump/year.\n4. Water Sustainability: Drip micro-irrigation and Alternate Wetting and Drying (AWD) reduce agricultural freshwater extraction by 40-50%."),
            ("Seasonal Farming Activities & Monthly Crop Calendar", "Kharif, Rabi & Zaid Operations", "PAGE 89: SEASONAL FARMING ACTIVITIES & MONTHLY CALENDAR\nComprehensive Month-by-Month Farming Guide:\n- May - June (Pre-Kharif): Summer deep ploughing, cleaning irrigation channels, soil testing, farmyard manure application, raising paddy nurseries, sowing cotton and direct-seeded rice (DSR).\n- July - August (Peak Kharif): Sowing soybean, maize, pulses, transplanting paddy (2-3 seedlings/hill), pre-emergence weed control, split urea application.\n- September - October (Kharif Harvest & Rabi Prep): Pest scouting (BPH, Bollworm), harvesting early kharif crops, field preparation for wheat and mustard, seed purchase and treatment.\n- November - December (Peak Rabi): Sowing wheat (Nov 1-20), CRI irrigation at 21 DAS, sowing mustard and chickpea, winter vegetable transplanting.\n- January - February (Rabi Care): Second/third irrigation for wheat (tillering, jointing), aphid monitoring in mustard, frost management (smoke/irrigation).\n- March - April (Rabi Harvest & Zaid Sowing): Harvesting wheat, mustard, chickpea, threshing and grain drying to <12% moisture, immediate sowing of summer moong and cucurbits."),
            ("Re-Entry Interval (REI) & Pre-Harvest Interval (PHI) Regulations", "Pesticide Safety & Residue Control", "PAGE 90: RE-ENTRY INTERVAL (REI) & RESIDUE MANAGEMENT\nSafe Agricultural Chemical Protocols:\n- Re-Entry Interval (REI): The minimum time required between pesticide application and safe entry into the field without PPE (typically 24 to 48 hours).\n- Pre-Harvest Interval (PHI): Mandatory duration between last spray and harvest: Mancozeb (7 days in vegetables), Chlorantraniliprole (3 days in tomato, 14 days in rice), Imidacloprid (14-21 days in cereals).\n- Maximum Residue Limits (MRL): Strict compliance ensures domestic food safety and agricultural export acceptance without rejected consignments."),
            ("Farm Machinery & Tractor Safety Protocols", "All Farm Machinery", "PAGE 91: TRACTOR & MACHINERY OPERATIONAL SAFETY\nSafety Protocols:\n1. Tractor Rollover Protective Structures (ROPS) and seatbelts save lives in 99% of rollover accidents.\n2. PTO Safety: Keep all Power Take-Off (PTO) safety guards intact; never step over rotating PTO shaft.\n3. Combine Harvester: Disengage cutter bar clutch and shut off engine before clearing clogged augers or belts.\n4. Electrical Safety: Maintain safe clearance (>3 meters) from overhead 11 kV high-tension farm power lines when transporting ladders or pipe sprayers."),
            ("Extreme Weather Precautions & Labor Safety", "Heat, Frost, Lightning, Storms", "PAGE 92: EXTREME WEATHER PRECAUTIONS & LABOR SAFETY\n1. Lightning Safety: Stop all field work during thunderstorms; avoid sheltering under isolated trees, metal sheds, or near tubewells. Take refuge in a masonry building or vehicle.\n2. Heatstroke Prevention: Provide potable drinking water with electrolytes (ORS) to farm laborers during summer (>40°C); schedule heavy fieldwork before 10 AM and after 4 PM.\n3. Cold Wave & Frost: Protect nursery beds with plastic tunnels or thatch coverings; irrigate fields during frost alerts.")
        ]
        s_title, crop, text = special_topics[p_num - 86]
        topic = f"Farm Procedures & Safety: {s_title}"
    else:
